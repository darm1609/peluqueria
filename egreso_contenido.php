...
<?php
	...
	function guardar($bd)
	{
		...
		if($bd->insertar_datos(5,$basedatos,"egreso","fecha","monto","motivo","fecha_num","login",$fecha,$_POST["monto"],$_POST["motivo"],$fecha_num,$_SESSION["login"]))
			return true;
		else
			return false;
	}
	...
	if($bd->conectado)
	{
		if(usuario_admin())
		{
			...
			<div class="w3-container">
				<button id="agregar_egreso" class="w3-button w3-blue"><i class="icon-plus4">&nbsp;</i>Agregar Egreso</button>
			</div>
			<?php
