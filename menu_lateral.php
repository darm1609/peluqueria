...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="usuario.php" style="text-decoration:none;" class="w3-bar-item w3-button w3-padding <?php if(isset($u)) echo "w3-blue"; ?>">Usuario</a>
    <a href="cliente.php" style="text-decoration:none;" class="w3-bar-item w3-button w3-padding <?php if(isset($c)) echo "w3-blue"; ?>">Cliente</a>
    <a href="empleado.php" class="w3-bar-item w3-button w3-padding <?php if(isset($e)) echo "w3-blue"; ?>">Empleado</a>
    <a href="tipo_trabajo.php" class="w3-bar-item w3-button w3-padding <?php if(isset($tipo)) echo "w3-blue"; ?>">Tipo de Trabajo</a>
    <a href="vale_pago.php" class="w3-bar-item w3-button w3-padding <?php if(isset($vale_pago)) echo "w3-blue"; ?>">Vale Pago</a>
    <a href="egreso.php" class="w3-bar-item w3-button w3-padding <?php if(isset($egreso)) echo "w3-blue"; ?>">Egreso</a>
    <a href="venta.php" class="w3-bar-item w3-button w3-padding <?php if(isset($venta)) echo "w3-blue"; ?>">Venta</a>
